    ...
    return(
        <View style={styles.screenWrapper}>
            ...
            <View style={{ paddingLeft: 30, paddingRight: 30 }}>
                ...
                <Text style={[styles.paragraph, styles.grayMiddlest, { paddingHorizontal: 16, textAlign: 'center' }]}>Your adventure journal preserving your memories as forever NFTs</Text>
